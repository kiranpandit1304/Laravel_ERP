...
//        $deduction['totalDeduction'] = SaturationDeduction::where('employee_id', $employeeId)->where('type', 'fixed')->get()->sum('amount');
    ...
    public static function addProductStock($product_id, $quantity, $type, $description,$type_id,$warehouse_id,$method_type)
    {
        ...
        $stocks->method_type = $method_type;
...
//        dd($settings);
    ...
    public static function getWarehouseProductStock($product_id, $warehouse_id)
    {

        $product     = ManageStock::where('product_id' , $product_id)->where('warehouse_id' , $warehouse_id)->first();
    ...
    public static function getProductName($product_id)
    {
        ...
        return $product     = ProductService::find($product_id);
    }

    public static function manageStock($warehouseID, $productID, $qty = 0)
    {
    ...
    //update quantity in warehouse stock
    public static function updateWarehouseStock($product_id, $quantity, $warehouse_id)
    {
