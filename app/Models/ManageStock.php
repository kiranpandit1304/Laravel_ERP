 ...
 * @mixin \Eloquent
 */
class ManageStock extends Model implements JsonResourceful
{
    ...
    public static function boot() {
        ...
        static::updating(function($model) {
            ...
            $product = ProductService::find($model->product_id);
    ...
    function prepareWarehouseAttributes(): array
    {
        $fields = [
            'product_id'    => $this->product_id,
            'quantity'      => $this->quantity,
    ...
    {
        $purchaseUnit = BaseUnit::whereId($this->product->product_unit)->first();
        if ($purchaseUnit) {
