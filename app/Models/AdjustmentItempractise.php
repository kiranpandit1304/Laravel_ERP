 ...
 * @mixin \Eloquent
 */
class AdjustmentItempractise extends Model implements JsonResourceful
{
    use HasFactory, HasJsonResourcefulData;

    protected $table = 'adjustment_items_practise';

    public const JSON_API_TYPE = 'adjustment_items_practise';
