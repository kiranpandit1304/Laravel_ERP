...
class ProductService extends Model
{
    ...
    {
        return $this->hasOne('App\Models\ManageStock', 'id', 'product_id');
    }
...
//            dd($pos);
    ...
    public function WarehouseProductStock($product_id,$warehouse_id)
    {
        $product=ManageStock::where('warehouse_id',$warehouse_id)->where('product_id',$product_id)->first();
        return !empty($product)?$product->quantity:0;
    }
