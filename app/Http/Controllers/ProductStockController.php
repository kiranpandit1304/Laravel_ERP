    ...
    public function edit($id)
    {
        ...
        if(\Auth::user()->can('edit product & service'))
        {
            if($productService->created_by == \Auth::user()->creatorId())
            {
                ...
                return view('productstock.edit', compact('productService','warehouse'));
            }
            else
            {
    ...
    public function update(Request $request, $id)
    {
        if(\Auth::user()->can('edit product & service'))
        {
            ...
            if($productService->created_by == \Auth::user()->creatorId())
            {
                ...
                Utility::addProductStock($productService->id, $request->quantity, $type, $description, $type_id,$request->warehouse_id,$request->method_type);
