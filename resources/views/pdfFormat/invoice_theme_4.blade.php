...
<head>
    ...
    <style>
        ...
        * {
        ...
        ul.bank_detail_mdle_div li span {
            font-size:13px;
        }
    ...
    <body style="">
    <main >
        <table class="" style="border:1px solid #000;">
            <tr>
                <td colspan="2" class="invoice-title" style="padding-left: 15px; padding-top:10px; padding-bottom:10px;">
            ...
            <tr>
                <td class="left_numbers_list" style="padding-left: 15px; padding-bottom:10px">
                    <table>
                        <tr>
                            <td><span>{{ !empty($saleInvoice->label_invoice_no) ? $saleInvoice->label_invoice_no : 'Invoice No'}}</span></td>
                            <td>{{@$saleInvoice->invoice_no}}</td>
                        </tr>
                        <tr>
                            <td><span>{{ !empty($saleInvoice->label_invoice_date) ? $saleInvoice->label_invoice_date : 'Invoice Date'}}</span></td>
                            <td>{{date('F d, Y', strtotime($saleInvoice->invoice_date))}}</td>
                        </tr>
                        <tr>
                            <td><span>{{ !empty($saleInvoice->label_invoice_due_date) ? $saleInvoice->label_invoice_due_date : 'Due Date'}}</span></td>
                            <td>{{date('F d, Y', strtotime($saleInvoice->due_date))}}</td>
                        </tr>
                            @php
                            ...
                            <tr><td><span>{{$custome_filed->key}}</span></td><td> {{$custome_filed->value}}</td></tr>
                            @endif
                            @endforeach
                            @endif
                    </table>
                </td>
                <td class="right" style="padding-right: 15px;">
                    <div class="sm_right">
                        @if(!empty($copy))                        
        ...
        <table class="einvoice" style="border:1px solid #000; border-top:0px;">
            <tr>
                <td class="left" style="padding-left: 15px; padding-bottom:15px; padding-top:10px;">
                    <ul>
                ...
                <td class="right" style="padding-right: 15px; padding-bottom:15px;">
                    <div class="rightside">
        ...
        <table class="invoice-details" style="border:1px solid #000; border-top:0px; height: 90px;">
            <tr>
                <td class="left" style="">
                    <div class="bill_by" style="border:1px solid #000; border-top:0px; border-left:0px; border-bottom:0px;">
                        <table>
                            <tr >
                                <td style="padding-left:15px; padding-bottom:10px; padding-top:5px;">
                ...
                <td class="right" style="">
                    <div class="bill_to" style="border:1px solid #000; border-top:0px; border-right:0px; border-bottom:0px; border-left:0px;">
                        <table>
                            <tr >
                                <td style="padding-left:15px; padding-bottom:10px; padding-top:5px;">
        ...
        <table class="invoice-details" style="border:1px solid #000; border-top:0px; height: 110px; margin-top:-3px;">
            <tr>
                <td class="left" style="">
                    <div class="bill_by_sfa" style="border:1px solid #000; border-top:0px; border-left:0px; border-bottom:0px;">
                        <table>
                            <tr >
                                <td style="padding-left:15px; padding-bottom:10px; padding-top:5px;">
                ...
                <td class="right" style="">
                    <div class="bill_to_sfa" style="border:1px solid #000; border-top:0px; border-right:0px; border-bottom:0px; border-left:0px;">
                        <table>
                            <tr >
                                <td style="padding-left:15px; padding-bottom:10px; padding-top:5px;">
        ...
        <table class="invoice-details" style="border:1px solid #000; border-top:0px; height: 150px; margin-top:-5px; margin-bottom:100px;">
            <tr>
                <td class="left">
                    <div class="bill_by_tdetails">
                        <table>
                            <tr>
                                <td style="padding-left:15px; padding-bottom:10px; padding-top:5px;">
        ...
        <table class="main_table">
            <thead>
                <tr class="table_bg" style="color: #fff;">
                    <th style="border-top-left-radius: 0px;" width="10" aria-label="Item Number"></th>
                   <?php                  
                    ...
                    @if(@$l_count <= 10)
                        @if(@$data->hide != 1)
                            ...
                            @elseif($key == (count($saleInvoiceAllData[0]->data)-1))
                                <th style="border-top-right-radius: 0px;">Total</th>
                            @else
        ...
        <table class="invoice-details" style="padding: 0px 0px; position:relative;">
            ...
            @if(!empty($SaleInvoiceBankDetails->account_holder_name) || !empty($SaleInvoiceBankDetails->account_no) || !empty($SaleInvoiceBankDetails->ifsc) || !empty($SaleInvoiceBankDetails->bank_name) )
                <td class="left_bank" style="padding-right: 0px;">
                    <div class="bank_details_card" style="border:1px solid #000;">
                        <table>
                            <tr>
                                <td style="padding:0px 0px;">
                                    <h2 style="margin-top:10px; padding-left:10px;">Bank Details</h2>
                ...
                @endif
                @endif
                <td class="center" style="padding-right: 0px; width: 33%;">
                    @if(!empty($SaleInvoiceSetting->is_bank_detail_show_onInv) && $SaleInvoiceSetting->is_bank_detail_show_onInv == 1)
                    @if(!empty($SaleInvoiceBankUpi->upi_id))
                        <div class="upi_details_card" style="border:1px solid #000;">
                            <h2 style="margin-top:10px;">UPI - Scan to Pay</h2><br/>
                            <span style="width: 120px; height: 120px; display: inline-block;">
                                <img style="border-radius: 0px; width: 100%; object-fit: contain;"
                ...
                <td class="right" style="padding-left: 0px;">
                    <div class="foot_right" style="text-align: left; border:1px solid #000;">
                        <table style="font-size: 14px; color:#000;">
                        <tr style="border-bottom:1px solid #000;">
                            <td style="padding-left: 10px; padding-bottom: 3px;">Amount</td>
                            <td style="padding-right: 10px; padding-bottom: 3px;"><span style="font-family: DejaVu Sans !important;">₹</span>{{ !empty($saleInvoice->final_amount) && $saleInvoice->final_amount!='undefined' ? $saleInvoice->final_amount : '0'}}</td>
                        </tr>
                        @if($saleInvoice->is_tax == 'IGST')
                        <tr style="border-bottom:1px solid #000;">
                            <td style="padding-left: 10px; padding-bottom: 3px;">SGST</td>
                            <td style="padding-right: 10px; padding-bottom: 3px;"><span style="font-family: DejaVu Sans !important;">₹</span> {{ !empty($saleInvoice->final_igst) && $saleInvoice->final_igst!='undefined' ? $saleInvoice->final_igst : '0'}}</td>
                        </tr>
                        @else
                        <tr style="border-bottom:1px solid #000;">
                            <td style="padding-left: 10px; padding-bottom: 3px;">SGST</td>
                            <td style="padding-right: 10px; padding-bottom: 3px;"><span style="font-family: DejaVu Sans !important;">₹</span>{{ !empty($saleInvoice->final_sgst) && $saleInvoice->final_sgst!='undefined' ? $saleInvoice->final_sgst : '0'}}</td>
                        </tr>
                        <tr style="border-bottom:1px solid #000;">
                            <td style="padding-left: 10px; padding-bottom: 3px;">CGST</td>
                            <td style="padding-right: 10px; padding-bottom: 3px;"><span style="font-family: DejaVu Sans !important;">₹</span>{{ !empty($saleInvoice->final_cgst) && $saleInvoice->final_cgst!='undefined' ? $saleInvoice->final_cgst : '0'}}</td>
                        </tr>
                         @endif
                            @php
                        ...
                        <tr style="border-bottom:1px solid #000;">
                            <td style="padding-left: 10px; padding-bottom: 5px;">Reductions</td>
                            <td style="padding-right: 10px; padding-bottom: 5px;"><span style="font-family: DejaVu Sans !important;">₹</span>({{@$saleInvoice->final_total_discount_reductions}} {{@$saleInvoice->final_total_discount_reductions_unit }})<span>({{$total_dic}})</span></td>
                        </tr>
                         @endif
                        ...
                        @endphp
                        <tr style="border-bottom:1px solid #000;">
                            <td style="padding-left: 10px; padding-bottom: 5px;">Extra Charges</td>
                            <td style="padding-right: 10px; padding-bottom: 5px;"><span style="font-family: DejaVu Sans !important;">₹</span>({{@$saleInvoice->final_extra_charges }} {{@$saleInvoice->extra_changes_unit }}) <span> {{ $total_extra}} </span></td>
                        </tr>
                         @endif
                    ...
                    font-family: DejaVu Sans !important;
                    margin-top: 15px;">
                            <td style="padding-left: 10px; padding-bottom: 5px;">Total (INR)</td>
                            <td style="padding-right: 10px; padding-bottom: 5px;"><span
                        ...
                        <tr style="border-bottom:1px solid #000;" align="left">
                            <th style="padding-left: 10px;">{{$custome_filed->key}} </th>
                            <td style="padding-right: 10px;">{{$custome_filed->value}}</td>
                        </tr>
                        @endif
                        @endforeach
                         </tbody>
        ...
        @if(!empty($advanceSetting) && $advanceSetting->show_hsn_summary == '1')
         <table class="invoice-hsn-table" cellpadding="0" cellspacing="0">
            <thead class="theme_color" style="opacity:0.1 !important;">
                ...
                <tr class="large-item-row aside-collpased">
                    ...
                    <th style="color:#fff;">Taxable Value</th>
                    @if($saleInvoice->is_tax == 'IGST')
                    <th style="color:#fff;" colspan="2">IGST</th>
                    @elseif($saleInvoice->is_tax == 'CGST')
                    <th style="color:#fff;" colspan="2">CGST</th>
                    <th style="color:#fff;" colspan="2">SGST</th>
                    @endif
