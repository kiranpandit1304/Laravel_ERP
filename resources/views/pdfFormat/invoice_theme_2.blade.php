...
<head>
    ...
    <style>
        ...
        * {
        ...
        .theme_color {
            ...
            <?php } else { ?>
                background-color: #0ad4a2 !important;
            <?php } ?>
        }
        .text_theme_color {
            <?php if (!empty(@$color) && @$color != '') { ?>
        ...
        .main_table {
            <?php if (!empty(@$color) && @$color != '') { ?>
                border: 1px solid <?php echo @$color; ?> !important;
            <?php } else { ?>
                border: 1px solid #0ad4a2 !important;
            <?php } ?>
        }
        ...
        .main_table tr {
            ...
            <?php } else { ?>
                border-right: 1px solid #0ad4a2 !important;
            <?php } ?>
        }
    ...
    <body style="">
    <main >
        <table class="" style="padding-bottom: 15px;">
            <tr>
                <td colspan="2" class="invoice-title" style="padding-bottom: 15px;">
                    <span class="bg_vbg">&nbsp;</span>
        ...
        <table class="einvoice theme_color" style="padding-bottom:25px; opacity: 0.1;">
            <tr style="opacity: 2;">
                <td class="left">
                    <ul>
        ...
        <table class="invoice-details" style="padding: 10px 0px; height: 110px;">
            <tr>
                <td class="left" style="padding-right: 5px;">
                    <div class="bill_by theme_color" style="opacity: 0.1;">
                        <table>
                            <tr style="opacity: 2;">
                                <td>
                ...
                <td class="right" style="padding-left: 5px;">
                    <div class="bill_to theme_color" style="opacity: 0.1;">
                        <table>
                            <tr style="opacity: 2;">
                                <td>
        ...
        <table class="invoice-details" style="padding-bottom: 10px; height: 110px;">
            <tr>
                <td class="left" style="padding-right: 5px;">
                    <div class="bill_by_sfa theme_color" style="opacity: 0.1;">
                        <table>
                            <tr style="opacity: 2;">
                                <td>
                ...
                <td class="right" style="padding-left: 5px;">
                    <div class="bill_to_sfa theme_color" style="opacity: 0.1;">
                        <table>
                            <tr style="opacity: 2;">
                                <td>
        ...
        <table class="invoice-details" style="padding-bottom: 10px; height: 150px; margin-top:0px;">
            <tr>
                <td class="left" style="padding-right: 0px;">
                    <div class="bill_by_tdetails theme_color" style="opacity: 0.1;">
                        <table>
                            <tr style="opacity: 2;">
                                <td>
        ...
        <table class="invoice-details" style="padding: 0px 0px; position:relative;">
            ...
            @if(!empty($SaleInvoiceBankDetails->account_holder_name) || !empty($SaleInvoiceBankDetails->account_no) || !empty($SaleInvoiceBankDetails->ifsc) || !empty($SaleInvoiceBankDetails->bank_name) )
                <td class="left_bank" style="padding-right: 10px; width: 33%;">
                    <div class="bank_details_card theme_color" style="opacity: 0.1;">
                        <table>
                            <tr style="opacity: 2;">
                                <td>
                                    <h2>Bank Details</h2>
                ...
                <td class="right" style="padding-left: 0px; width: 33%;">
                    <div class="foot_right" style="text-align: left;">
                        ...
                        <tr>
                            <td style="padding-bottom: 5px;">Reductions ({{@$saleInvoice->final_total_discount_reductions}} {{@$saleInvoice->final_total_discount_reductions_unit }})</td>
                            <td style="padding-bottom: 5px;"><span style="font-family: DejaVu Sans !important;">₹</span><span>({{$total_dic}})</span></td>
                        </tr>
                         @endif
                        ...
                        @endphp
                        <tr>
                            <td style="padding-bottom: 5px;">Extra Charges ({{@$saleInvoice->final_extra_charges }} {{@$saleInvoice->extra_changes_unit }})</td>
                            <td style="padding-bottom: 5px;"><span style="font-family: DejaVu Sans !important;">₹</span><span> {{ $total_extra}} </span></td>
                        </tr>
                         @endif
