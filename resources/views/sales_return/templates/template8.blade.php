            ...
            <div class="invoice-preview-inner">
                <div class="editor-content">
                    <div class="preview-main client-preview">
                        <div data-v-136bf9b5="" class="d" style="width:710px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-136bf9b5="" class="d-inner">
                                <div data-v-136bf9b5="" class="row">
                                    <div data-v-136bf9b5="" class="col-66">
                                        ...
                                        <h3 data-v-136bf9b5="">@if($settings['company_name']){{$settings['company_name']}}@endif</h3>
                                        ...
                                        <pre data-v-136bf9b5="">@if($settings['company_address']){{$settings['company_address']}}@endif</pre>
                                        <p data-v-136bf9b5="">@if($settings['company_city']) {{$settings['company_city']}}, @endif
                                            @if($settings['company_state']){{$settings['company_state']}}@endif
                                            </p>
                                        <p data-v-136bf9b5="">@if($settings['company_country']) {{$settings['company_country']}}@endif
                                    ...
                                    <div data-v-136bf9b5="" class="col-33">
                                        <h1 data-v-136bf9b5="" class="fancy-title mb5" style="color: {{$color}};">{{__('Sale')}}</h1>
                                    ...
                                    <div data-v-136bf9b5="" class="col-33">
                                        <table data-v-136bf9b5="" class="summary-table">
                                            ...
                                            <tr data-v-136bf9b5="">
                                                ...
                                                <td data-v-136bf9b5="" class="text-right">{{Utility::purchaseNumberFormat($settings,$sales->sale_id)}}</td>
                                            </tr>
                                            <tr data-v-136bf9b5="">
                                                <td data-v-136bf9b5="" class="fwb">{{__('Issue Date')}}:</td>
                                                <td data-v-136bf9b5="" class="text-right">{{Utility::dateFormat($settings,$sales->sale_date)}}</td>
                                            </tr>
