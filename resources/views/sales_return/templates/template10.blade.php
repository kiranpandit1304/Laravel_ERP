                        ...
                        <div data-v-b8f60a0c="" class="d" style="width:710px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-b8f60a0c="" class="d-inner">
                                <div data-v-b8f60a0c="" class="row">
                                    <div data-v-b8f60a0c="" class="col-33"><h1 data-v-b8f60a0c="" class="fancy-title tu mb5" style="color: {{$color}}; border-top: 15px solid {{$color}};">{{__('Sale')}}</h1></div>
                                ...
                                <div data-v-b8f60a0c="" class="row">
                                    <div data-v-b8f60a0c="" class="col-66"><strong data-v-b8f60a0c="" class="tu mb5" style="color: {{$color}};">{{__('From')}}:</strong>
                                        ...
                                        <p data-v-b8f60a0c="">@if($settings['company_city']) {{$settings['company_city']}}, @endif
                                    ...
                                    <div data-v-b8f60a0c="" class="col-33">
                                        <table data-v-b8f60a0c="" class="summary-table">
                                            ...
                                            <tr data-v-b8f60a0c="">
                                                ...
                                                <td data-v-b8f60a0c="" class="text-right">{{Utility::purchaseNumberFormat($settings,$sales->sale_id)}}</td>
                                            </tr>
                                            <tr data-v-b8f60a0c="">
                                                <td data-v-b8f60a0c="" class="tu fwb" style="color: {{$color}};">{{__('Sale Date')}}:</td>
                                                <td data-v-b8f60a0c="" class="text-right">{{Utility::dateFormat($settings,$sales->sale_date)}}</td>
                                            </tr>
