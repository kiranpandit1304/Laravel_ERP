@if($settings['company_zipcode']) - {{$settings['company_zipcode']}}@endif@php
            ...
            <div class="invoice-preview-inner">
                <div class="editor-content">
                    <div class="preview-main client-preview">
                        <div data-v-7d9d14b5="" class="d" style="width:710px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-7d9d14b5="" class="d-inner" style="border-right: 50px solid {{$color}};">
                                <div data-v-7d9d14b5="" class="row">
                                    <div data-v-7d9d14b5="" class="col-2"><h1 data-v-7d9d14b5="" class="fancy-title tu mb5" style="color: {{$color}};">{{__('Sale')}}</h1>
                                        <h3 data-v-7d9d14b5="">{{Utility::purchaseNumberFormat($settings,$sales->sale_id)}}</h3>
                                        <p data-v-7d9d14b5="">{{Utility::dateFormat($settings,$sales->sale_date)}}</p>
                                    </div>
                                ...
                                <div data-v-7d9d14b5="" class="row">
                                    <div data-v-7d9d14b5="" class="col-66">
                                        ...
                                        <p data-v-7d9d14b5="">@if($settings['company_city']) {{$settings['company_city']}}, @endif
                                            @if($settings['company_state']){{$settings['company_state']}}@endif
                                            </p>
                                        <p data-v-7d9d14b5="">@if($settings['company_country']) {{$settings['company_country']}}@endif
                                    ...
                                    <div data-v-7d9d14b5="" class="col-33">
                                        <table data-v-7d9d14b5="" class="summary-table">
                                            ...
                                            <tr data-v-7d9d14b5="">
                                                ...
                                                <td data-v-7d9d14b5="" class="text-right">{{Utility::dateFormat($settings,$sales->due_date)}}</td>
                                            </tr>
                                             @if(!empty($customFields) && count($sales->customField)>0)
                                                @foreach($customFields as $field)
                                                    <tr data-v-37eeda86="">
                                                        <td  data-v-37eeda86="" class="tu">{{$field->name}} :</td>
                                                        <td data-v-37eeda86="" class="text-right"> {{!empty($sales->customField)?$sales->customField[$field->id]:'-'}}</td>
                                                    </tr>
                                                @endforeach
                                            @endif
                                            </tbody>
