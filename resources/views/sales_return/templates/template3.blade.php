            ...
            <div class="invoice-preview-inner">
                <div class="editor-content">
                    <div class="preview-main client-preview">
                        <div data-v-e95a8a8c="" class="d" style="width:710px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-e95a8a8c="" class="d-inner">
                                <div data-v-e95a8a8c="" class="row">
                                    <div data-v-e95a8a8c="" class="col-2">
                                        <h1 data-v-e95a8a8c="" class="fancy-title tu mb5" style="color: {{$color}};">{{__('Sale')}}</h1></div>
                                ...
                                <div data-v-e95a8a8c="" class="row">
                                    <div data-v-e95a8a8c="" class="col-66"><strong data-v-e95a8a8c="" class="tu mb5" style="color: {{$color}};">{{__('From')}}:</strong>
                                        <p data-v-e95a8a8c="">@if($settings['company_name']){{$settings['company_name']}}@endif</p>
                                        ...
                                        <pre data-v-e95a8a8c="">@if($settings['company_address']){{$settings['company_address']}}@endif</pre>
                                        <p data-v-e95a8a8c="">@if($settings['company_city']) {{$settings['company_city']}}, @endif
                                            @if($settings['company_state']){{$settings['company_state']}}@endif
                                           </p>
                                        <p data-v-e95a8a8c="">@if($settings['company_country']) {{$settings['company_country']}}@endif
                                    ...
                                    <div data-v-e95a8a8c="" class="col-33">
                                        <table data-v-e95a8a8c="" class="summary-table">
                                            ...
                                            <tr data-v-e95a8a8c="">
                                                ...
                                                <td data-v-e95a8a8c="" class="text-right">{{Utility::purchaseNumberFormat($settings,$sales->sales_id)}}</td>
                                            </tr>
                                            <tr data-v-e95a8a8c="">
                                                <td data-v-e95a8a8c="" class="tu fwb" style="color: {{$color}};">{{__('Sale Date')}}:</td>
                                                <td data-v-e95a8a8c="" class="text-right">{{Utility::dateFormat($settings,$sales->sale_date)}}</td>
                                            </tr>
                                        ...
                                        <div class="float-right mt-5">
                                            {!! DNS2D::getBarcodeHTML(route('sale.link.copy',\Crypt::encrypt($sales->sale_id)), "QRCODE",2,2) !!}
                                ...
                                <div data-v-e95a8a8c="" class="d-table">
                                    <div data-v-e95a8a8c="" class="d-table">
                                        ...
                                        <div class="d-table-body">
                                            @if(isset($sales->itemData) && count($sales->itemData) > 0)
                                                @foreach($sales->itemData as $key => $item)
                                        ...
                                        <div class="d-table-tr" style="border-bottom:1px solid {{$color}};">
                                            ...
                                            <div class="d-table-td w-3">
                                                <pre data-v-f2a183a6="">{{$sales->totalQuantity}}</pre>
                                            </div>
                                            <div class="d-table-td w-4">
                                                <pre data-v-f2a183a6="">{{Utility::priceFormat($settings,$sales->totalRate)}}</pre>
                                            </div>
                                            <div class="d-table-td w-5">
                                                <pre data-v-f2a183a6="">{{Utility::priceFormat($settings,$sales->totalTaxPrice) }}</pre>
                                            </div>

                                                <div class="d-table-td w-4">
                                                    <pre data-v-f2a183a6="">{{Utility::priceFormat($settings,$sales->totalDiscount)}}</pre>
                                                </div>


                                            <div class="d-table-td w-4">
                                                    <span>{{Utility::priceFormat($settings,$sales->getSubTotal())}}
                                                    </span>
                                            </div>
                                        </div>
                                        ...
                                        <div data-v-f2a183a6="" class="d-table-footer">
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-summary">
                                                <div data-v-f2a183a6="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-value">{{Utility::priceFormat($settings,$sales->getSubTotal())}}</div>
                                                </div>
                                                @if($sales->getTotalDiscount())
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label">{{__('Discount')}}:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value">{{Utility::priceFormat($settings,$sales->getTotalDiscount())}}</div>
                                                    </div>
                                                @endif
                                                @if(!empty($sales->taxesData))
                                                    @foreach($sales->taxesData as $taxName => $taxPrice)
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-value">{{Utility::priceFormat($settings,$sales->getSubTotal()-$sales->getTotalDiscount()+$sales->getTotalTax())}}</div>
                                                </div>
                                                <div data-v-f2a183a6="" class="d-table-summary-item">
                                                    <div data-v-f2a183a6="" class="d-table-label">{{__('Paid')}}:</div>
                                                    <div data-v-f2a183a6="" class="d-table-value">{{Utility::priceFormat($settings,($sales->getTotal()-$sales->getDue()))}}</div>
                                                </div>

                                                <div data-v-f2a183a6="" class="d-table-summary-item">
                                                    <div data-v-f2a183a6="" class="d-table-label">{{__('Due Amount')}}:</div>
                                                    <div data-v-f2a183a6="" class="d-table-value">{{Utility::priceFormat($settings,$sales->getDue())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
