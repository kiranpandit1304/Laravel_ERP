                        ...
                        <div data-v-363339a0="" class="d" style="width:710px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-363339a0="" class="d-inner">
                                <div data-v-363339a0="" class="row">
                                    <div data-v-363339a0="" class="col-2"><h1 data-v-363339a0="" class="fancy-title tu mb5" style="color: {{$color}};">{{__('Sale')}}</h1>
                                        ...
                                        <p data-v-363339a0="">@if($settings['company_city']) {{$settings['company_city']}}, @endif
                                            @if($settings['company_state']){{$settings['company_state']}}@endif
                                            </p>
                                        <p data-v-363339a0="">@if($settings['company_country']) {{$settings['company_country']}}@endif
                                        ...
                                        <div data-v-363339a0="" class="">
                                            <table data-v-363339a0="" class="summary-table">
                                                ...
                                                <tr data-v-363339a0="">
                                                    ...
                                                    <td data-v-363339a0="" class="text-right">{{Utility::purchaseNumberFormat($settings,$sales->sale_id)}}</td>
                                                </tr>
                                                <tr data-v-363339a0="">
                                                    <td data-v-363339a0="" class="tu fwb" style="color: {{$color}};">{{__('Sale Date')}}:</td>
                                                    <td data-v-363339a0="" class="text-right">{{Utility::dateFormat($settings,$sales->sale_date)}}</td>
                                                </tr>
