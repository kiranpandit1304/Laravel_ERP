                        ...
                        <table class="table datatable">
                            ...
                            @foreach ($categories as $category)
                                ...
                                <td class="font-style">{{ $category->name }}</td>
                                    <td class="font-style">{{ $category->parent_name }}</td>
                                    <td class="Action">
                                        <span>
...
@push('script-page')
<script>
$("body").on("change", ".is_parent", function(){
    if($(this).val()==1){
    $(".parent_div").removeClass("hide-d");
    $(".parent_categpry").val(''); 
    $(".parent_categpry").prop('required',true);
  }else{
   $(".parent_div").addClass("hide-d");
   $(".parent_categpry").prop('required',false);
