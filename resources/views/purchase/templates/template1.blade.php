                                            ...
                                            <div data-v-f2a183a6="" class="d-table">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-footer">
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-summary">
                                                        ...
                                                        @endif
                                                        @if(!empty($purchase->taxCharges))
                                                        @foreach($purchase->taxCharges as $taxName => $taxItem)
                                                        @if($taxItem->slug='tax')
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label">{{@$taxItem->charges_type_name}} :</div>
                                                            <div data-v-f2a183a6="" class="d-table-value">{{number_format(($purchase->getSubTotal()/100) * $taxItem->tax_rate, 2)}} ( {{ @$taxItem->tax_rate}} ) %</div>
                                                        </div>
