...
<li class="breadcrumb-item">{{__('Sale Create')}}</li>
@endsection

@section('content')
<div class="row">
    {{ Form::open(array('url' => 'sale','class'=>'w-100')) }}
    <div class="col-12">
                        ...
                        <tbody class="ui-sortable" data-repeater-item>
                            <tr> 
                                ...
                                <td width="25%" class="form-group pt-1">
                                    {{ Form::select('item', [],'', array('class' => 'form-control sale_prod select2 item','data-url'=>route('sale.product'),'required'=>'required')) }}
                                </td>
                                <td class=" stock_d">
                                    0
                                </td>
