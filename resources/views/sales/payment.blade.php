{{ Form::open(array('route' => array('sale.payment', $sales->id),'method'=>'post','enctype' => 'multipart/form-data')) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group  col-md-6">
            ...
            {{ Form::text('amount',$sales->getDue(), array('class' => 'form-control','required'=>'required')) }}
        </div>
        <div class="form-group  col-md-6">
