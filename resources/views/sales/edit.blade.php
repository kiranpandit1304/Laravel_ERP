...
@section('content')
    <div class="row">
        ...
        {{ Form::model($sales, array('route' => array('sale.update', $sales->id), 'method' => 'PUT','class'=>'w-100')) }}
        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" id="vender-box">
                                ...
                                {{ Form::select('customer_id', $venders,null, array('class' => 'form-control select','id'=>'customer_d','data-url'=>route('sale.customer'),'required'=>'required')) }}
                            </div>
        ...
        <div class="col-12">
            ...
            <div class="card repeater" data-value='{!! json_encode($sales->items) !!}'>
        ...
        <div class="modal-footer">
            <input type="button" value="{{__('Cancel')}}" onclick="location.href = '{{route("sale.index")}}';" class="btn btn-light">
...
@push('script-page') 
<script> 
        var itemURL= <?= json_encode(route('sale.items')) ?>;
        var purchase_id = '{{@$sales->id}}';
</script>
