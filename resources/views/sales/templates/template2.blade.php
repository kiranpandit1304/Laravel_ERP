            ...
            <div class="invoice-preview-inner">
                <div class="editor-content">
                    <div class="preview-main client-preview">
                        <div data-v-37eeda86="" class="d" style="width:710px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-37eeda86="" class="d-inner">
                                ...
                                <div class="float-right mt-5">
                                    {!! DNS2D::getBarcodeHTML(route('sale.link.copy',\Crypt::encrypt($sales->sales_id)), "QRCODE",2,2) !!}
                                </div>

                                <div data-v-37eeda86="" class="col-33">
                                    <strong data-v-37eeda86="" class="tu mb5" style="color: {{$color}};">{{__('Sale')}}</strong>
                                    <table data-v-37eeda86="" class="summary-table">
                                        <tbody data-v-37eeda86="">
                                        <tr data-v-37eeda86="">
                                            <td data-v-37eeda86="" class="tu">{{__('Number')}}:</td>
                                            <td data-v-37eeda86="" class="text-right">{{Utility::purchaseNumberFormat($settings,$sales->sales_id)}}</td>
                                        </tr>
                                        <tr data-v-37eeda86="">
                                            <td data-v-37eeda86="" class="tu">{{__('Sale Date')}}:</td>
                                            <td data-v-37eeda86=""
                                                class="text-right">{{Utility::dateFormat($settings,$sales->sale_date)}}</td>
                                        </tr>
...
{{--                                                    <div data-v-f2a183a6="" class="d-table-value">{{Utility::priceFormat($settings,($sales->billTotalDebitNote()))}}</div>--}}
{{--                                                </div>--}}
                                                <div data-v-f2a183a6="" class="d-table-summary-item">
