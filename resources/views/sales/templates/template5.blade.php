            ...
            <div class="invoice-preview-inner">
                <div class="editor-content">
                    <div class="preview-main client-preview">
                        <div data-v-e23d9750="" class="d" style="width:710px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-e23d9750="" class="d-inner">
                                <div data-v-e23d9750="" class="row">
                                    <div data-v-e23d9750="" class="col-66">
                                        <h1 data-v-e23d9750="" class="fancy-title tu mb5" style="background: {{$color}};color:{{$font_color}}">{{__('Sale')}}</h1>
                                        <div>
                                    ...
                                    <div data-v-e23d9750="" class="col-33">
                                        ...
                                        <p data-v-e23d9750="">@if($settings['company_name']){{$settings['company_name']}}@endif</p>
                                        ...
                                        <pre data-v-e23d9750="">@if($settings['company_address']){{$settings['company_address']}}@endif</pre>
                                        <p data-v-e23d9750="">@if($settings['company_city']) {{$settings['company_city']}}, @endif @if($settings['company_state']){{$settings['company_state']}}@endif
                                            </p>
                                        <p data-v-e23d9750="">@if($settings['company_country']) {{$settings['company_country']}}@endif
                                    ...
                                    <div data-v-e23d9750="" class="col-33">
                                        <table data-v-e23d9750="" class="summary-table">
                                            ...
                                            <tr data-v-e23d9750="">
                                                ...
                                                <td data-v-e23d9750="" class="text-right">{{Utility::purchaseNumberFormat($settings,$sales->sale_id)}}</td>
                                            </tr>
                                            <tr data-v-e23d9750="">
                                                <td data-v-e23d9750="" class="tu fwb">{{__('Sale Date')}}:</td>
                                                <td data-v-e23d9750="" class="text-right">{{Utility::dateFormat($settings,$sales->sale_date)}}</td>
                                            </tr>
