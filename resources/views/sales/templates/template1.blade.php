                                ...
                                <div data-v-f2a183a6="" class="d-header" style="background: {{$color}};color:{{$font_color}}">
                                    <div data-v-f2a183a6="" class="d-header-inner">
                                        ...
                                        <div data-v-f2a183a6="" class="d-header-50 d-right">
                                            <div data-v-f2a183a6="" class="d-title ">{{__('Sale')}}</div>
                                            <table data-v-f2a183a6="" class="summary-table">
                                                <tbody data-v-f2a183a6="">
                                                    <tr>
                                                        <td>{{__('Number')}}:</td>
                                                        <td>{{Utility::purchaseNumberFormat($settings,$sales->sales_id)}}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>{{__('Sale Date')}}:</td>
                                                        <td>{{Utility::dateFormat($settings,$sales->sale_date)}}</td>
                                                    </tr>
                                            ...
                                            <div data-v-f2a183a6="" class="d-table">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-footer">
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-summary">
                                                        ...
                                                        @endif
                                                        @if(!empty($sales->taxCharges))
                                                        @foreach($sales->taxCharges as $taxName => $taxItem)
                                                        @if($taxItem->slug='tax')
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label">{{@$taxItem->charges_type_name}} :</div>
                                                            <div data-v-f2a183a6="" class="d-table-value">{{number_format(($sales->getSubTotal()/100) * $taxItem->tax_rate, 2)}} ( {{ @$taxItem->tax_rate}} ) %</div>
                                                        </div>

                                                        @else if($taxItem->slug='shipping')
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label">{{@$taxItem->charges_type_name}} :</div>
                                                            <div data-v-f2a183a6="" class="d-table-value">{{number_format($taxItem->tax_rate, 2)}}</div>
                                                        </div>
                                                        @endif
                                                        @endforeach
                                                        @endif
