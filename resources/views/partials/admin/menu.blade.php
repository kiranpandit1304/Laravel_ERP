        ...
        <div class="navbar-content">
            @if(\Auth::user()->type != 'client')
                    ...
                    @if(\Auth::user()->show_account() == 1)
                            ...
                            <li class="dash-item dash-hasmenu {{ (Request::route()->getName() == 'print-setting' || Request::segment(1) == 'customer' || Request::segment(1) == 'vender' || Request::segment(1) == 'proposal' || Request::segment(1) == 'bank-account' || Request::segment(1) == 'bank-transfer' || Request::segment(1) == 'invoice' || Request::segment(1) == 'revenue' || Request::segment(1) == 'credit-note' || Request::segment(1) == 'taxes' || Request::segment(1) == 'product-category' ||
                                ...
                                <ul class="dash-submenu">
                                    ...
                                    @endif
                                    @if( Gate::check('manage bill')  ||  Gate::check('manage payment') ||  Gate::check('manage debit note'))
                                        <li class="dash-item dash-hasmenu {{(Request::segment(1) == 'expense-category' || Request::segment(1) == 'expense')? 'active dash-trigger' :''}}">
                                            <a class="dash-link" href="#">{{__('Pos Expense')}}<span class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                            <ul class="dash-submenu">
                                                <li class="dash-item {{ (Request::route()->getName() == 'expense-category.index' || Request::route()->getName() == 'expense-category.create' || Request::route()->getName() == 'expense-category.edit' || Request::route()->getName() == 'expense-category.show') ? ' active' : '' }}">
                                                    <a class="dash-link" href="{{ route('expense-category.index') }}">{{__('Category')}}</a>
                                                </li>
                                                <li class="dash-item {{ (Request::route()->getName() == 'expense.index' || Request::route()->getName() == 'expense.create' || Request::route()->getName() == 'expense.edit') ? ' active' : '' }}">
                ...
                <!--------------------- End User Managaement System----------------------------------->
                    ...
                    @if( Gate::check('manage product & service') || Gate::check('manage product & service') || Gate::check('manage constant category'))
                        <li class="dash-item dash-hasmenu">
                            <a href="#!" class="dash-link ">
                            ...
                            <ul class="dash-submenu">
                                @if(Gate::check('manage constant category'))
                                    <li class="dash-item {{ (Request::segment(1) == 'product-category.index')?'active':''}}">
                                        <a href="{{ route('product-category.index') }}" class="dash-link">{{__('Category')}}
                                        </a>
                                    </li>
                                    @endif
                                ...
                                @endif
                                @if(Gate::check('manage product & service'))
                                    <li class="dash-item {{ (Request::segment(1) == 'product-brand')?'active':''}}">
                                        <a href="{{ route('product-brand.index') }}" class="dash-link">{{__('Brand')}}
                                        </a>
                                    </li>
                                @endif
                                @if(Gate::check('manage product & service'))
                                    <li class="dash-item {{ (Request::segment(1) == 'product-unit.index')?'active':''}}">
                                        <a href="{{ route('product-unit.index') }}" class="dash-link">{{__('Units')}}
                                        </a>
                                    </li>
                                @endif
                                @if(Gate::check('manage constant unit'))
                                <li class="dash-item {{ (Request::segment(1) == 'base-unit')?'active':''}}">
                                        <a href="{{ route('base-unit.index') }}" class="dash-link">{{__('Base Unit')}}
                                        </a>
                                    </li>
                                @endif
                                @if(Gate::check('manage product & service'))
                                    <li class="dash-item {{ (Request::segment(1) == 'adjustments')?'active':''}}">
                                        <a href="{{ route('adjustments.index') }}" class="dash-link">{{__('Product Adjustment')}}
                                        </a>
                                    </li>
                                @endif
                        ...
                        @if( Gate::check('manage warehouse') ||  Gate::check('manage purchase')  || Gate::check('manage pos') || Gate::check('manage print settings'))
                            <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'warehouse' || Request::segment(1) == 'purchase' || Request::route()->getName() == 'pos.barcode' || Request::route()->getName() == 'pos.print' )?' active dash-trigger':''}}">
                                ...
                                <ul class="dash-submenu {{ (Request::segment(1) == 'warehouse' || Request::segment(1) == 'purchase')?'show':''}}">
                                    ...
                                    @endcan
                                    @can('manage purchase-return')
                                    @endcan
                                        <li class="dash-item {{ (Request::route()->getName() == 'purchase_return.index' || Request::route()->getName() == 'purchase_return.create' || Request::route()->getName() == 'purchase_return.edit' || Request::route()->getName() == 'purchase_return.show') ? ' active' : '' }}">
                                            <a class="dash-link" href="{{ route('purchase_return.index') }}">{{__('Purchase Return')}}</a>
                                        </li>

                                        <li class="dash-item {{ (Request::route()->getName() == 'sale.index' || Request::route()->getName() == 'sale.create' || Request::route()->getName() == 'sale.edit' || Request::route()->getName() == 'sale.show') ? ' active' : '' }}">
                                            <a class="dash-link" href="{{ route('sale.index') }}">{{__('Sale')}}</a>
                                        </li>

                                        <li class="dash-item {{ (Request::route()->getName() == 'sale_return.index' || Request::route()->getName() == 'sale_return.create' || Request::route()->getName() == 'sale_return.edit' || Request::route()->getName() == 'sale_return.show') ? ' active' : '' }}">
                                            <a class="dash-link" href="{{ route('sale_return.index') }}">{{__('Sale Return')}}</a>
                                        </li>
                                        <li class="dash-item {{ (Request::route()->getName() == 'transfer.index' || Request::route()->getName() == 'transfer.create' || Request::route()->getName() == 'transfer.edit' || Request::route()->getName() == 'transfer.show') ? ' active' : '' }}">
                                            <a class="dash-link" href="{{ route('transfer.index') }}">{{__('Transfer')}}</a>
                                        </li>
                                    @can('manage pos')
                ...
                @if(Gate::check('manage company settings'))
                            <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'charges-types') ? ' active' : '' }}">
                                <a href="{{ route('charges-types.index') }}" class="dash-link">
                                    <span class="dash-micon"><i class="ti ti-settings"></i></span><span class="dash-mtext">{{__('Charges Types')}}</span>
                                </a>
                            </li>
                        @endif
                        @if(Gate::check('manage company settings'))
                            <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'status-types') ? ' active' : '' }}">
                                <a href="{{ route('status-types.index') }}" class="dash-link">
                                    <span class="dash-micon"><i class="ti ti-settings"></i></span><span class="dash-mtext">{{__('Status Types')}}</span>
                                </a>
                            </li>
                        @endif
