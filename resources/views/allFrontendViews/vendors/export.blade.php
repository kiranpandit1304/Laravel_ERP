                     ...
                     <div class="col-lg-12 col-sm-12 col-xs-12">
                         <div class="shinvite">
                             ...
                             <div class="shi_body">
                                 <div class="grid">
                                     <label class="card ">
                                         <input name="plan" class="radio export_option" value="pdf" type="radio" checked />
                                         <span class="plan-details">
                                             <img src="{{asset('unsync_assets/assets/images/pdf.png') }}" alt="" />
                                             <h2>PDF</h2>
                                         </span>
                                     </label>
                                     <label class="card " data-id="excel">
                                         <input name="plan" class="radio export_option" value="excel" type="radio" />
                                     ...
                                     <label class="card " data-id="tally">
                                         <input name="plan" class="radio export_option" value="tally" type="radio" />
                                         <span class="plan-details" aria-hidden="true">
                             ...
                             <div class="shi_footer">
                                 <button class="done_btn export_cut_btn" data-url="{{url('/api/ProductExport?guard=WEB&platform=Unesync', $enypt_id)}}">Export</button> &nbsp; &nbsp;
                             </div>
                         </div>
                     </div>
                 </div>
