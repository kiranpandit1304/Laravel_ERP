 <!-- Create Vendor - Bottom Full Screen Popup -->
                                 ...
                                 <div class="accordion-body">
                                     <div class="gst_btns">
                                         <a href="#" class="have_gst">
                                             ...
                                             Vendor have <br />GST number
                                         </a>
                                         <a href="#" class="no_gst active">
                                             <span><img src="{{asset('unsync_assets/assets/images/taxes.png')}}" /></span>
                                             Vendor don't <br />have GST number
                                         </a>
                                     </div>
                                     ...
                                     <div class="row hide_gst">
                                         <div class="form-group col-sm-12 flush">
                                            <label>
                                                 <input type="text" class="gst_field get_gst_data" id="gst_no"  value="" placeholder="GST Number" />
                                     ...
                                     <div class="row">
                                         <div class="form-group withbutton col-sm-12">
                                            <label>
                                                 <input type="text" class="business_name" id="fname" name="name" value="" placeholder="Business/Vendor name" />
                                                 <span>Business/Vendor name</span>
                                             </label>
                                             <div class="text_center">
                                                 <button type="submit" class="btn_comman save_customer">Create Vendor</button>
                                             </div>
                                         </div>
                                     </div>
                                     <div class="customer_created hide-d">
                                         <div class="cc_card">
                                             ...
                                             <div class="content_cc">
                                                 <h6>Vendor created successfully</h6>
                                                 <p>This vendor is created successfully now you can skip and go to dashboard</p>
                                 ...
                                 <div class="accordion-body">
                                     ...
                                     <div class="row">
                                         <div class="form-group col-sm-12">
                                            <label>
                                                <input id="billing_address" type="text" placeholder="Street Address" name="billing_address">
                                     ...
                                     <div class="row">
                                         <div class="form-group col-sm-12">
                                            <label>
                                                <input type="text" class="billing_zip_code" id="billing_zip" placeholder="Postal Code / Zip Code" name="billing_zip" value="" />
                                     ...
                                     <div class="row">
                                         <div class="form-group col-sm-6">
                                            <label>
                                                 <input type="email" class="" id="email" name="email" placeholder="Email" value="" />
                                                 <span>Email</span>
                                            </label>
                                         </div>
                                         <div class="form-group col-sm-6">
                                            <label>
                                                 <input type="text" class="" id="nature_of_business" name="nature_of_business" placeholder="Nature of Business" value="" />
                                     ...
                                     <div class="shipping_info">
                                         ...
                                         <div class="row">
                                             <div class="form-group col-sm-6">
                                                 <select class="js-example-placeholder-single-cuntry js-states form-control shipping_country sv_shipping_country" name="shipping_country">
                                 ...
                                 <div class="accordion-body">
                                     ...
                                     <div class="row">
                                         <div class="input-group form-group col-sm-12 full_in_icon">
                                             <label>
                                                 <input type="text" required="" class=""  name="tax_number" id="final_gst" aria-label="GST" aria-describedby="basic-addon2" placeholder="GST Number">
                                                 <span>GST Number</span>
                                             </label>
                                         ...
                                         <div class="input-group form-group col-sm-12 full_in_icon">
                                            <label>
                                                 <input type="text" required="" id="pan" name="pan" aria-label="pan" aria-describedby="basic-addon2" placeholder="PAN">
                                                 <span>PAN</span>
                                            <label>
                                             <div class="input-group-append">
                                     ...
                                     <div class="sd_check">
                                         <input type="checkbox" name="is_msme"  value="1" id="ismsme_vendor" />
                                         <label class="pull-right text" for="ismsme_vendor">Is MSME?</label>
                                     </div>
                                 </div>
                             </div>
                         </div>
                         <div class="accordion-item">
                             ...
                             <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                 <div class="accordion-body">
                                     ...
                                     <div class="row">
                                         <div class="form-group col-sm-6">
                                             <select class="js-example-placeholder-single-cuntry js-states form-control  country_id bk_country" name="country_id">
                                             <option>Select Country</option>
                                                 @foreach($countryList as $country)
                                                 <option value="{{@$country->id}}" {{ $country->id == 101 ? 'selected' : ''}}>{{@$country->name}}</option>
                                                 @endforeach
                                     ...
                                     <div class="row">
                                         ...
                                         <div class="input-group form-group col-sm-6">
                                                <label>
                                                 <input type="text" required="" name="payment_terms_days" id="payment_terms_days" aria-label="Payment Terms" aria-describedby="basic-addon2" placeholder="Payment Terms">
