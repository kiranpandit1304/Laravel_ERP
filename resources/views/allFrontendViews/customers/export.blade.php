                     ...
                     <div class="col-lg-12 col-sm-12 col-xs-12">
                         <div class="shinvite">
                             ...
                             <div class="shi_body">
                                 <div class="grid">
                                     <label class="card ">
                                         <input name="plan" class="radio export_option" value="pdf" data-type="" type="radio" checked />
                                     ...
                                     <label class="card " data-id="excel">
                                         <input name="plan" class="radio export_option" value="excel" data-type="" type="radio" />
                             ...
                             <!-- <form class="pdf_select_form hide-d" action="{{url('/api/CustomerPdf')}}" id="mulislectedCusExport" method="get">
                                 <div class="hiden_cust_export_val"></div>
                                 <button type="submit" class="export export_cut_btn" data-url="{{url('/api/CustomerPdf')}}">Export</button>
                             </form>
                             <form class="excel_select_form hide-d" action="{{url('/api/CustomerExport')}}" id="mulislectedCusExport" method="get">
                                 <div class="hiden_cust_export_val"></div>
                                 <button type="submit" class="export export_cut_btn" data-url="{{url('/api/CustomerPdf')}}">Export</button>
                             </form> -->
                                 <button type="submit" class="done_btn export_cut_btn expt_btn" data-url="{{url('/api/CustomerPdf?guard=WEB&platform=Unesync', $enypt_id,)}}">Export</button> &nbsp; &nbsp;
                             </div>
                         </div>
                     </div>
                    </form>
