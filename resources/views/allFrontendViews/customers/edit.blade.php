...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" style="overflow: scroll;">
    <div class="offcanvas-header">
        ...
        <h5 class="offcanvas-title cus_title" id="offcanvasExampleLabel">Johan Prince</h5>
    ...
    <div class="offcanvas-body">
        <div class="offcanvas_details">
            <form id="CustomerDetailForm1" action="javascript:void(0)" method="post">
                <div class="od_card">
                    ...
                    <div class="od_card_body">
                        <ul>
                            <li>
                                <label for="">Business/Customer name</label>
                ...
                <div class="od_card">
                    ...
                    <div class="od_card_body">
                        <ul>
                            ...
                            <li>
                                <div class="sd_check">
                                    <input type="checkbox" class="inp_tax_detail is_msme _msme_chk" name="is_msme" value="1" id="ismsme" disabled> 
                                    <label class="pull-right text" for="ismsme">Is MSME?</label>
                                </div>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="bottom_bar_d">
                <a href="#" class="delte_cutomer_btn"><iconify-icon icon="mingcute:delete-2-line"></iconify-icon> Delete Customer</a>
            </div>
            @endif
        </div>
    </div>
