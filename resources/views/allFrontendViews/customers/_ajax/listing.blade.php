<div class="table_upper_wrapper">
        ...
        <table id="user-list-table" class="table" role="grid" aria-describedby="user-list-page-info">
            <thead>
                <tr>
                    ...
                    <th class="business_col" scope="col">Business/Customer name</th>
            ...
            <tbody>
                ...
                <tr data-bs-toggle="offcanvas" href="#offcanvasExample1" role="button" aria-controls="offcanvasExample">
                    ...
                    <td class="business_col offcanvasModal" data-id="{{@$customer->customer_id}}" > {{!empty($customer->name) ? $customer->name : '-' }} 
    ...
    <div class="tfooter">
        <div id="user-list-page-info" class="col-md-6">
            <span>Showing {{$customers->firstItem()}} to {{$customers->lastItem()}} of {{$customers->total()}} Customers</span>
        </div>
        <div class="col-md-6">
