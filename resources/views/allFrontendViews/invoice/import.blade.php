                                            ...
                                            <div class="step-tabs">
                                                <div class="step-tab active" id="step-i1">
                                                    ...
                                                    <div class="templates">
                                                        ...
                                                        <p>We've created a custom template based on your Vendor attributes.</p>
                                                        <a href="{{asset('/export_sample/sample-vendor.csv')}}" target="_blank">Download Template</a>
                                                    </div>
                                                ...
                                                <div class="step-tab" id="step-i2">
                                                    ...
                                                    <div class="templates">
                                                        ...
                                                        <p>We've created a custom data based on your Vendor attributes.</p>
