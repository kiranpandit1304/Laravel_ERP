...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('Purchase Return Edit')}}</li>
@endsection

@section('content')
    <div class="row">
        {{ Form::model($purchase, array('route' => array('purchase_return.update', $purchase->id), 'method' => 'PUT','class'=>'w-100')) }}
        <div class="col-12">
                ...
                <div class="card-body table-border-style ">
                    <div class="table-responsive">
                        <table class="table  mb-0" data-repeater-list="items" id="sortable-table">
                            ...
                            <tfoot id="tfoot">
                            @include('purchase.taxCalculation')
                            </tfoot>
                        </table>
                        <div class="row m-4">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {{ Form::text('discount',$purchase->discount, array('class' => 'form-control inp_discount','required'=>'required','placeholder'=>__('Discount'))) }}
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                            <div class="form-group">
                                {{ Form::textarea('description', $purchase->description, ['class'=>'form-control','rows'=>'3','placeholder'=>__('Description')]) }}</div>
                            </div>
                        </div>
                    </div>
                    </div>
        ...
        <div class="modal-footer">
            <input type="button" value="{{__('Cancel')}}" onclick="location.href = '{{route("purchase_return.index")}}';" class="btn btn-light">
...
@push('script-page')
<script>
        var itemURL= <?= json_encode(route('purchase_return.items')) ?>;
