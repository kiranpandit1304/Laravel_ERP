...
@section('page-title')
{{__('Purchase Return Create')}}
@endsection
@section('breadcrumb')
<li class="breadcrumb-item"><a href="{{route('dashboard')}}">{{__('Dashboard')}}</a></li>
<li class="breadcrumb-item"><a href="{{route('purchase_return.index')}}">{{__('Purchase Return')}}</a></li>
<li class="breadcrumb-item">{{__('Purchase Return Create')}}</li>
@endsection


@section('content')
<div class="row">
    {{ Form::open(array('url' => 'purchase_return','class'=>'w-100')) }}
    <div class="col-12">
                        ...
                        <tbody class="ui-sortable" data-repeater-item>
                            <tr>
                                <td width="25%" class="form-group pt-1">
                                    {{ Form::select('item', $product_services,'', array('class' => 'form-control select2 item','data-url'=>route('purchase_return.product'),'required'=>'required')) }}
                                </td>
                                <td class=" stock_d">
                                    0
                                </td>
