...
@section('page-title')
{{__('Adjustment Create')}}
@endsection
@section('breadcrumb')
<li class="breadcrumb-item"><a href="{{route('dashboard')}}">{{__('Dashboard')}}</a></li>
<li class="breadcrumb-item"><a href="{{route('adjustments.index')}}">{{__('Adjustment')}}</a></li>
<li class="breadcrumb-item">{{__('Adjustment Create')}}</li>
@endsection

@section('content')
<div class="row">
    {{ Form::open(array('url' => 'adjustments','class'=>'w-100')) }}
    <div class="col-12">
                        ...
                        <tbody class="ui-sortable" data-repeater-item>
                            <tr>
                                <td width="25%" class="form-group pt-1">
                                    {{ Form::select('item', $product_services,'', array('class' => 'form-control select2 item','data-url'=>route('adjustments.productStock'),'required'=>'required')) }}
                                </td>
                                <td class="sku">
                                    0.00
                                </td>
                                ...
                                <td class="text-end ">
                                    <div class="form-group col-md-12">
                                        {!! Form::select('method_type', $days= array(""=>"Select Type","1"=>"Addition","2" => "Subtraction"),null,  ['class' => 'form-control days', 'required'=>'required']) !!}
                                    </div>
                                </td>
                                <td>
 ...
 var selector = "body";
    ...
    $(document).on('change', '.item', function() {
        ...
        $.ajax({
            ...
            data: {
                'product_id': iteams_id, 'warehouse_id':warehouse_id,
            },
            cache: false,
