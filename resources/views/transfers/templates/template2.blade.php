                        ...
                        <div data-v-37eeda86="" class="d" style="width:710px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-37eeda86="" class="d-inner">
                                ...
                                <div data-v-37eeda86="" class="col-33">
                                    <strong data-v-37eeda86="" class="tu mb5" style="color: {{$color}};">{{__('Purchase')}}</strong>
                                    <table data-v-37eeda86="" class="summary-table">
                                        <tbody data-v-37eeda86="">
                                        <tr data-v-37eeda86="">
                                            <td data-v-37eeda86="" class="tu">{{__('Number')}}:</td>
                                            <td data-v-37eeda86="" class="text-right">{{Utility::purchaseNumberFormat($settings,$purchase->purchase_id)}}</td>
                                        </tr>
                                        <tr data-v-37eeda86="">
                                            <td data-v-37eeda86="" class="tu">{{__('Purchase Date')}}:</td>
                                            <td data-v-37eeda86=""
                                                class="text-right">{{Utility::dateFormat($settings,$purchase->purchase_date)}}</td>
                                        </tr>
...
{{--                                                    <div data-v-f2a183a6="" class="d-table-value">{{Utility::priceFormat($settings,($purchase->billTotalDebitNote()))}}</div>--}}
{{--                                                </div>--}}
                                                <div data-v-f2a183a6="" class="d-table-summary-item">
