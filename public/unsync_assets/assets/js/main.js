(function(jQuery) {
    ...
    jQuery(document).ready(function() {
        ...
        $("button.showtcond").click(function () {
            ...
            var last_val = $(".is_terms_req").val();
            last_val = last_val==0 ? 1 : 0
            $(".is_terms_req").val(last_val);

        });
        $("button.showNote").click(function () {
            $(".addition_note").toggleClass("hide");
            var last_val = $(".is_additional_notes_req").val();
            last_val = last_val==0 ? 1 : 0
            $(".is_additional_notes_req").val(last_val);
        });
        $("button.showAttch").click(function () {
            $(".attech").toggleClass("hide");
            var last_val = $(".is_attactments_req").val();
            last_val = last_val==0 ? 1 : 0
            $(".is_attactments_req").val(last_val);
        });
        ...
        $("button.showadinfo").click(function () {
            ...
            var last_val = $(".is_additional_info_req").val();
            last_val = last_val==0 ? 1 : 0
            $(".is_additional_info_req").val(last_val);
        });
