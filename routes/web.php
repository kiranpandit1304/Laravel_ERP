...
Route::post('productservice/get-sub-units', 'ProductServiceController@getSubUnits')->name('productservice.getAllSubUnits');
Route::post('productservice/get-sub-categories', 'ProductServiceController@getSubCategories')->name('productservice.getAllSubCategories');
...
Route::resource('adjustments', 'AdjustmentController')->middleware(
    [
        'auth',
        'XSS', 'revalidate',
    ]
);
Route::post('adjustments/productStock', 'AdjustmentController@productStock')->name('adjustments.productStock')->middleware(
    [
        'auth',
        'XSS', 
    ]
...
Route::group(
    ...
    function () {
        ...
        Route::post('bill/customer', 'CustomerController@customer')->name('bill.customer');
...
Route::resource('base-unit', 'BaseUnitController')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
...
Route::resource('product-brand', 'ProductBrandController')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
...
Route::resource('charges-types', 'ChargesTypesController')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
...
Route::resource('status-types', 'StatusTypesController')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
...
// End Task Module ExpensePOSController

// Tranfer Module TransfersController
Route::get('/vendor/transfer/{id}/', 'TransfersController@purchaseLink')->name('transfer.link.copy')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
...
Route::group(
    ...
    function () {
        Route::get('transfer/items', 'TransfersController@items')->name('transfer.items');
        Route::resource('transfer', 'TransfersController');
        Route::get('transfer/{id}/payment', 'TransfersController@payment')->name('transfer.payment');
        Route::post('transfer/{id}/payment', 'TransfersController@createPayment')->name('transfer.payment');
        Route::post('transfer/{id}/payment/{pid}/destroy', 'PurcaseController@paymentDestroy')->name('transfer.payment.destroy');
        Route::post('transfer/product/destroy', 'TransfersController@productDestroy')->name('transfer.product.destroy');
        Route::post('transfer/vender', 'TransfersController@vender')->name('transfer.vender');
        Route::post('transfer/product', 'TransfersController@product')->name('transfer.product');
        Route::get('transfer/create/{cid}', 'TransfersController@create')->name('transfer.create');
        Route::get('transfer/{id}/sent', 'TransfersController@sent')->name('transfer.sent');
        Route::get('transfer/{id}/resent', 'TransfersController@resent')->name('transfer.resent');
    }
);
Route::get('transfer/pdf/{id}', 'TransfersController@purchase')->name('transfer.pdf')->middleware(
    [
        'XSS',
        'revalidate',
    ]
...
//  Expense category
Route::resource('expense-category', 'ExpenseCategoryController')->middleware(
    [
        'auth',
        'XSS',
    ]
...
//  Expense POS
Route::resource('expense', 'ExpensePOSController')->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::get('/vendor/sale/{id}/', 'SaleController@purchaseLink')->name('sale.link.copy')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
...
Route::get('/vendor/sale_return/{id}/', 'SaleReturnController@purchaseLink')->name('sale_return.link.copy')->middleware(
    [
        'auth',
        'XSS',
        'revalidate',
...
Route::group(
    ...
    function () {
// get-purchased-product-list
        Route::get('sale/items', 'SaleController@items')->name('sale.items');
        Route::resource('sale', 'SaleController');
        //    Route::get('/bill/{id}/', 'SaleController@saleLink')->name('sale.link.copy');
        Route::get('sale/{id}/payment', 'SaleController@payment')->name('sale.payment');
        Route::post('sale/{id}/payment', 'SaleController@createPayment')->name('sale.payment');
        Route::post('sale/{id}/payment/{pid}/destroy', 'PurcaseController@paymentDestroy')->name('sale.payment.destroy');

        Route::post('sale/product/destroy', 'SaleController@productDestroy')->name('sale.product.destroy');
        Route::post('sale/customer', 'SaleController@customer')->name('sale.customer');
        Route::post('sale/product', 'SaleController@product')->name('sale.product');
        Route::get('sale/create/{cid}', 'SaleController@create')->name('sale.create');
        Route::get('sale/{id}/sent', 'SaleController@sent')->name('sale.sent');
        Route::get('sale/{id}/resent', 'SaleController@resent')->name('sale.resent');
    }
...
Route::group(
    ...
    function () {
        ...
        Route::get('sale_return/items', 'SaleReturnController@items')->name('sale_return.items');
        Route::resource('sale_return', 'SaleReturnController');
        //    Route::get('/bill/{id}/', 'SaleReturnController@saleLink')->name('sale_return.link.copy');
        Route::get('sale_return/{id}/payment', 'SaleReturnController@payment')->name('sale_return.payment');
        Route::post('sale_return/{id}/payment', 'SaleReturnController@createPayment')->name('sale_return.payment');
        Route::post('sale_return/{id}/payment/{pid}/destroy', 'PurcaseController@paymentDestroy')->name('sale_return.payment.destroy');

        Route::post('sale_return/product/destroy', 'SaleReturnController@productDestroy')->name('sale_return.product.destroy');
        Route::post('sale_return/customer', 'SaleReturnController@customer')->name('sale_return.customer');
        Route::post('sale_return/product', 'SaleReturnController@product')->name('sale_return.product');
        Route::get('sale_return/create/{cid}', 'SaleReturnController@create')->name('sale_return.create');
        Route::get('sale_return/{id}/sent', 'SaleReturnController@sent')->name('sale_return.sent');
        Route::get('sale_return/{id}/resent', 'SaleReturnController@resent')->name('sale_return.resent');
    }
...
Route::get('purchase_return/pdf/{id}', 'PurchaseReturnController@purchase')->name('purchase_return.pdf')->middleware(
    [
        'XSS',
        'revalidate',
    ]
);
Route::get('sale/pdf/{id}', 'SaleController@sale')->name('sale.pdf')->middleware(
    [
        'XSS',
        'revalidate',
    ]
...
Route::post('get-state-list', 'WarehouseController@stateList'); 
Route::post('get-city-list', 'WarehouseController@cityList'); 
Route::post('get-purchased-productList', 'WarehouseController@productList')->name('get-purchased-product-list'); 
...
Route::group(
    ...
    function () {
        Route::get('purchase_return/items', 'PurchaseReturnController@items')->name('purchase_return.items');

        Route::resource('purchase_return', 'PurchaseReturnController');
        //    Route::get('/bill/{id}/', 'PurchaseReturnController@purchaseLink')->name('purchase.link.copy');
        Route::get('purchase_return/{id}/payment', 'PurchaseReturnController@payment')->name('purchase_return.payment');
        Route::post('purchase_return/{id}/payment', 'PurchaseReturnController@createPayment')->name('purchase_return.payment');
        Route::post('purchase_return/{id}/payment/{pid}/destroy', 'PurcaseController@paymentDestroy')->name('purchase_return.payment.destroy');

        Route::post('purchase_return/product/destroy', 'PurchaseReturnController@productDestroy')->name('purchase_return.product.destroy');
        Route::post('purchase_return/vender', 'PurchaseReturnController@vender')->name('purchase_return.vender');
        Route::post('purchase_return/product', 'PurchaseReturnController@product')->name('purchase_return.product');
        Route::get('purchase_return/create/{cid}', 'PurchaseReturnController@create')->name('purchase_return.create');
        Route::get('purchase_return/{id}/sent', 'PurchaseReturnController@sent')->name('purchase_return.sent');
        Route::get('purchase_return/{id}/resent', 'PurchaseReturnController@resent')->name('purchase_return.resent');
    }

);
/*Route::post('get-state-list', 'WarehouseController@stateList');
Route::post('get-city-list', 'WarehouseController@cityList');*/
// Route::resource('base-unit', 'BaseUnitController');
/**/
...
////**===================================== NEW UI SECTION START HERE =======================================================////
// Aut
Route::get('/en/login', 'Frontend\FrontendAuthViewController@showLoginForm')->name('fn.login');
Route::get('/en/login/number', 'Frontend\FrontendAuthViewController@showLoginNumberForm')->name('fn.login_number');
Route::get('/en/login/otp', 'Frontend\FrontendAuthViewController@showLogiOtpnForm')->name('fn.login_otp');
Route::get('/en/signup/otp', 'Frontend\FrontendAuthViewController@showRegisterationOtpForm')->name('fn.signupOtp');
Route::get('/en/signup/password', 'Frontend\FrontendAuthViewController@showRegisterationPasswordForm')->name('fn.signupPass');
Route::get('/en/signup/{invitee_id?}', 'Frontend\FrontendAuthViewController@showRegisterationForm')->name('fn.signup');

Route::get('/en/password/forgot', 'Frontend\FrontendAuthViewController@showforgotForm')->name('fn.forgot');
Route::get('/en/password/otp', 'Frontend\FrontendAuthViewController@showResetOtpForm')->name('fn.resetOtp');
Route::get('/en/password/resets', 'Frontend\FrontendAuthViewController@showResetPasswordForm')->name('fn.resetPass');

// Dashboard
Route::get('/en/dashboard/{uid?}', 'Frontend\FrontEndViewsController@dashboard')->name('fn.dashboard');
// Customers & Vendors
Route::get('/en/customers/{uid?}', 'Frontend\FrontEndViewsController@customerView')->name('fn.customers');
Route::get('/en/vendors/{uid?}', 'Frontend\FrontEndViewsController@VendorView')->name('fn.vendors');
// Product & inventory
Route::get('/en/products/inventory/{uid?}', 'Frontend\FrontEndViewsController@InventoryView')->name('fn.inventory');
Route::get('/en/products/inventory/item/variate/{enypt_id?}', 'Frontend\FrontEndViewsController@getAllProducts')->name('fn.get_item_vairate');
Route::get('/en/products/brand/{uid?}', 'Frontend\FrontEndViewsController@BrandListView')->name('fn.inventory.brand');
Route::get('/en/products/get_single_brand/{id?}', 'Frontend\FrontEndViewsController@getSingleBrand')->name('fn.inventory.get_single_brand');
Route::get('/en/products/category/{uid?}', 'Frontend\FrontEndViewsController@categoryListView')->name('fn.inventory.category');
Route::get('/en/products/get_single_category/{id?}', 'Frontend\FrontEndViewsController@getSingleCategory')->name('fn.inventory.get_single_category');
// Team managment
Route::get('/en/manage/team/{uid?}', 'Frontend\FrontEndViewsController@teamView')->name('fn.team_management');
// Setting
Route::get('/en/manage/setting/{uid?}', 'Frontend\FrontEndViewsController@settingView')->name('fn.business_setting');
// Invoice
Route::get('/en/invoices/{uid?}', 'Frontend\FrontEndViewsController@showInvoice')->name('fn.invoices');
Route::get('/en/invoice/step1/{uid?}/{inv_id?}', 'Frontend\FrontEndViewsController@invoiceStep1View')->name('fn.invoice_step1');
Route::get('/en/invoice/step2/{uid?}/{inv_id?}', 'Frontend\FrontEndViewsController@invoiceStep2View')->name('fn.invoice_step2');
Route::get('/en/invoice/step3/{uid?}/{inv_id?}', 'Frontend\FrontEndViewsController@invoiceStep3View')->name('fn.invoice_step3');
Route::get('/en/invoice/show/{uid?}/{inv_id?}', 'Frontend\FrontEndViewsController@invoiceShow')->name('fn.invoice_show');
Route::get('/en/invoice/view/{inv_id?}', 'Frontend\FrontEndViewsController@invoiceShoIinShortUrl')->name('fn.invoice_with_shorturl');
